program Main
    ...
    !*****************************************************************************
    !
    !! SubDelaunay is the main program for TABLE_DELAUNAY.
    !
    !  Discussion:
    !
    ...
    !
    implicit none
    double precision, allocatable, dimension ( :, : ) :: node_xy
    ...
    integer ( kind = 4 ) triangle_num, c
    integer ( kind = 4 ) triangle_order
    real, dimension(2315,2) :: DelTriangle
    real, dimension(2315,2) :: DelTriangle3
    integer (kind = 4) :: j,i
...
subroutine dtris2 ( point_num, point_xy, tri_num, tri_vert, tri_nabe )
    ...
    lr = lrline( point_xy(1,m), point_xy(2,m), point_xy(1,m1), point_xy(2,m1), point_xy(1,m2), point_xy(2,m2), 0.0D+00 )
...
subroutine file_column_count ( input_file_name, column_num )
    ...
    return
end subroutine file_column_count
...
subroutine r8mat_header_read ( input_filename, m, n )
    ...
    return
end subroutine r8mat_header_read
...
subroutine swapec ( i, top, btri, bedg, point_num, point_xy, tri_num, tri_vert, tri_nabe, stack, ierr )
